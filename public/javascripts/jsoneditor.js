...
JSONEditor.defaults.editors.array = JSONEditor.AbstractEditor.extend({
  ...
  addRow: function(value, initial) {
    ...
    if(!self.hide_delete_buttons) {
      self.rows[i].delete_button = this.getButton(self.getItemTitle(),'delete','Borrar '+self.getItemTitle());
    ...
    if(i && !self.hide_move_buttons) {
      self.rows[i].moveup_button = this.getButton('','moveup','Mover Arriba');
    ...
    if(!self.hide_move_buttons) {
      self.rows[i].movedown_button = this.getButton('','movedown','Mover Abajo');
  ...
  addControls: function() {
    ...
    this.add_row_button = this.getButton(this.getItemTitle(),'add','Agregar '+this.getItemTitle());
    ...
    this.remove_all_rows_button = this.getButton('All','delete','Borrar todo');
...
JSONEditor.defaults.languages.es = {
   ...
   */
  error_notset: "Debe setear una propiedad",
  /**
   ...
   */
  error_enum: "Valor debe ser uno de los enumerados",
  /**
   * When a value doesn't validate any schema of a 'anyOf' combination
   */
  error_anyOf: "El valor devbe validar en cualquier combinacion de los esquemas",
  /**
   * When a value doesn't validate
   * @variables This key takes one variable: The number of schemas the value does not validate
   */
  error_oneOf: 'El valor devbe validar exactamente en uno de los esquemas. Actualmente valida con {{0}} de los esquemas.',
  /**
   * When a value does not validate a 'not' schema
   */
  error_not: "Valor no debe validar con el esquema provisto",
  /**
   * When a value does not match any of the provided types
   */
  error_type_union: "Valor debe ser uno de los tipos provistos",
  /**
   * When a value does not match the given type
   * @variables This key takes one variable: The type the value should be of
   */
  error_type: "Valor debe ser del tipo {{0}}",
  /**
   *  When the value validates one of the disallowed types
   */
  error_disallow_union: "Valor no debe ser de los tipos prohibidos",
  /**
   *  When the value validates a disallowed type
   * @variables This key takes one variable: The type the value should not be of
   */
  error_disallow: "Valor no debe ser del tipo {{0}}",
  /**
   * When a value is not a multiple of or divisible by a given number
   * @variables This key takes one variable: The number mentioned above
   */
  error_multipleOf: "Valor debe ser un multiplo de {{0}}",
  /**
   * When a value is greater than it's supposed to be (exclusive)
   * @variables This key takes one variable: The maximum
   */
  error_maximum_excl: "Valor debe ser menor a {{0}}",
  /**
   * When a value is greater than it's supposed to be (inclusive
   * @variables This key takes one variable: The maximum
   */
  error_maximum_incl: "Valor debe ser a lo mas {{0}}",
  /**
   * When a value is lesser than it's supposed to be (exclusive)
   * @variables This key takes one variable: The minimum
   */
  error_minimum_excl: "Valor debe ser mayor que {{0}}",
  /**
   * When a value is lesser than it's supposed to be (inclusive)
   * @variables This key takes one variable: The minimum
   */
  error_minimum_incl: "Valor debe ser al menos {{0}}",
  /**
   * When a value have too many characters
   * @variables This key takes one variable: The maximum character count
   */
  error_maxLength: "Valor debe tener a lo mas {{0}} caracteres de largo",
  /**
   * When a value does not have enough characters
   * @variables This key takes one variable: The minimum character count
   */
  error_minLength: "Valor debe tener a menos {{0}} caracteres de largo",
  /**
   * When a value does not match a given pattern
   */
  error_pattern: "El valor debe ser compatible con el patrón dado",
  /**
   * When an array has additional items whereas it is not supposed to
   */
  error_additionalItems: "No se pueden agregar más items a este arreglo",
  /**
   * When there are to many items in an array
   * @variables This key takes one variable: The maximum item count
   */
  error_maxItems: "El valor debe tener a lo más {{0}} items",
  /**
   * When there are not enough items in an array
   * @variables This key takes one variable: The minimum item count
   */
  error_minItems: "El valor debe tener a lo menos {{0}} items",
  /**
   * When an array is supposed to have unique items but has duplicates
   */
  error_uniqueItems: "El arreglo debe tener items únicos",
  /**
   * When there are too many properties in an object
   * @variables This key takes one variable: The maximum property count
   */
  error_maxProperties: "Objeto debe tener a lo más {{0}} propiedades",
  /**
   * When there are not enough properties in an object
   * @variables This key takes one variable: The minimum property count
   */
  error_minProperties: "Objeto debe tener a lo menos {{0}} propiedades",
  /**
   * When a required property is not defined
   * @variables This key takes one variable: The name of the missing property
   */
  error_required: "Objeto le falta la propiedad necesaria '{{0}}'",
  /**
   * When there is an additional property is set whereas there should be none
   * @variables This key takes one variable: The name of the additional property
   */
  error_additional_properties: "No se permiten propiedades adicionales, pero la propiedad {{0}} está ocupada",
  /**
